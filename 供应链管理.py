...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        self.label_47.setGeometry(QtCore.QRect(20, 760, 871, 61))
        self.label_47.setObjectName("label_47")
        self.tabWidget.addTab(self.tab_2, "")
        self.tab_3 = QtWidgets.QWidget()
        self.tab_3.setObjectName("tab_3")
        self.frame = QtWidgets.QFrame(self.tab_3)
        self.frame.setGeometry(QtCore.QRect(10, 20, 1341, 501))
        self.frame.setFrameShape(QtWidgets.QFrame.StyledPanel)
        self.frame.setFrameShadow(QtWidgets.QFrame.Raised)
        self.frame.setObjectName("frame")
        self.layoutWidget = QtWidgets.QWidget(self.frame)
        self.layoutWidget.setGeometry(QtCore.QRect(1150, 30, 161, 301))
        ...
        self.verticalLayoutWidget.setGeometry(QtCore.QRect(950, 30, 160, 301))
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(460, 10, 451, 481))
        self.groupBox_6.setObjectName("groupBox_6")
        self.lineEdit_28 = QtWidgets.QLineEdit(self.groupBox_6)
        self.lineEdit_28.setGeometry(QtCore.QRect(170, 100, 251, 121))
        self.lineEdit_28.setObjectName("lineEdit_28")
        self.label_31 = QtWidgets.QLabel(self.groupBox_6)
        self.label_31.setGeometry(QtCore.QRect(50, 140, 84, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_29.setGeometry(QtCore.QRect(170, 230, 251, 101))
        self.lineEdit_29.setObjectName("lineEdit_29")
        self.label_32 = QtWidgets.QLabel(self.groupBox_6)
        self.label_32.setGeometry(QtCore.QRect(60, 260, 84, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_25.setGeometry(QtCore.QRect(170, 30, 245, 21))
        self.lineEdit_25.setObjectName("lineEdit_25")
        self.label_27 = QtWidgets.QLabel(self.groupBox_6)
        self.label_27.setGeometry(QtCore.QRect(50, 30, 84, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.comboBox_3.setGeometry(QtCore.QRect(170, 70, 245, 21))
        self.comboBox_3.setObjectName("comboBox_3")
        self.label_26 = QtWidgets.QLabel(self.groupBox_6)
        self.label_26.setGeometry(QtCore.QRect(50, 70, 84, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_24.setGeometry(QtCore.QRect(170, 350, 245, 21))
        self.lineEdit_24.setObjectName("lineEdit_24")
        self.label_25 = QtWidgets.QLabel(self.groupBox_6)
        self.label_25.setGeometry(QtCore.QRect(70, 350, 55, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.lineEdit_27.setGeometry(QtCore.QRect(170, 400, 245, 21))
        self.lineEdit_27.setObjectName("lineEdit_27")
        self.label_29 = QtWidgets.QLabel(self.groupBox_6)
        self.label_29.setGeometry(QtCore.QRect(80, 400, 42, 20))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.groupBox_5.setGeometry(QtCore.QRect(10, 10, 421, 481))
        self.groupBox_5.setObjectName("groupBox_5")
        self.formLayoutWidget_3 = QtWidgets.QWidget(self.groupBox_5)
        self.formLayoutWidget_3.setGeometry(QtCore.QRect(10, 20, 371, 311))
        ...
        self.formLayout_3.setWidget(7, QtWidgets.QFormLayout.FieldRole, self.comboBox_2)
        ...
        self.formLayout_3.setWidget(9, QtWidgets.QFormLayout.FieldRole, self.comboBox)
        ...
        self.formLayout_3.setWidget(11, QtWidgets.QFormLayout.FieldRole, self.comboBox_4)
        ...
        self.formLayout_3.setWidget(12, QtWidgets.QFormLayout.LabelRole, self.label_46)
        self.comboBox_5 = QtWidgets.QComboBox(self.formLayoutWidget_3)
        self.comboBox_5.setObjectName("comboBox_5")
        self.formLayout_3.setWidget(12, QtWidgets.QFormLayout.FieldRole, self.comboBox_5)
        ...
        self.formLayout_3.setWidget(13, QtWidgets.QFormLayout.LabelRole, self.label_24)
        self.lineEdit_23 = QtWidgets.QLineEdit(self.formLayoutWidget_3)
        self.lineEdit_23.setObjectName("lineEdit_23")
        self.formLayout_3.setWidget(13, QtWidgets.QFormLayout.FieldRole, self.lineEdit_23)
        self.radioButton = QtWidgets.QRadioButton(self.groupBox_5)
        self.radioButton.setGeometry(QtCore.QRect(390, 30, 31, 19))
        self.radioButton.setText("")
        self.radioButton.setObjectName("radioButton")
        self.radioButton_2 = QtWidgets.QRadioButton(self.groupBox_5)
        self.radioButton_2.setGeometry(QtCore.QRect(390, 60, 31, 19))
        self.radioButton_2.setText("")
        self.radioButton_2.setObjectName("radioButton_2")
        self.radioButton_3 = QtWidgets.QRadioButton(self.groupBox_5)
        self.radioButton_3.setGeometry(QtCore.QRect(390, 90, 31, 19))
        self.radioButton_3.setText("")
        self.radioButton_3.setObjectName("radioButton_3")
        self.radioButton_4 = QtWidgets.QRadioButton(self.groupBox_5)
        self.radioButton_4.setGeometry(QtCore.QRect(390, 210, 31, 19))
        self.radioButton_4.setText("")
        self.radioButton_4.setObjectName("radioButton_4")
        self.label_17 = QtWidgets.QLabel(self.groupBox_5)
        self.label_17.setGeometry(QtCore.QRect(20, 370, 84, 21))
        font = QtGui.QFont()
        font.setPointSize(12)
        font.setBold(True)
        font.setWeight(75)
        ...
        self.tableView_3.setGeometry(QtCore.QRect(10, 540, 1341, 371))
        ...
        self.layoutWidget1.setGeometry(QtCore.QRect(20, 40, 571, 101))
    ...
    def retranslateUi(self, Form):
        ...
        self.label_47.setText(_translate("Form", "<html><head/><body><p><span style=\" font-size:12pt; font-weight:600; color:#ff0000;\">备注：指定订单号更新，只需填写进度和完成时间，其他项没有更新到</span></p></body></html>"))
        ...
        self.groupBox_6.setTitle(_translate("Form", "沟通信息"))
        ...
        self.groupBox_5.setTitle(_translate("Form", "客户信息"))
        ...
        self.label_23.setText(_translate("Form", "客户等级"))
        self.label_22.setText(_translate("Form", "开发层级"))
        self.label_45.setText(_translate("Form", "客户类型"))
        self.label_46.setText(_translate("Form", "产品类型"))
...
def show_shengchan(self):
    ...
    if ui.lineEdit_16.text() != "":
        sql = "SELECT * FROM shengchan WHERE id = '{}'".format(str(ui.lineEdit_16.text()))
    else:
...
def show_kehu(self):
    ...
    if a1+a2+a3+a4 == 1 :
        if ui.lineEdit_20.text() != "" :
            sql =  "SELECT 日期,公司名,采购账号,对接人,联系方式,客户来源,星级,合作情况,客户类型,产品类型,累计合作金额,备注,id,报价 FROM kehu WHERE 对接人 LIKE '%%%%%s%%%%'" % str(ui.lineEdit_20.text())
        elif ui.lineEdit_19.text() != "" :
            sql =  "SELECT 日期,公司名,采购账号,对接人,联系方式,客户来源,星级,合作情况,客户类型,产品类型,累计合作金额,备注,id,报价 FROM kehu WHERE 公司名 LIKE '%%%%%s%%%%'" % str(ui.lineEdit_19.text())
        elif ui.lineEdit_21.text() != "" :
            sql =  "SELECT 日期,公司名,采购账号,对接人,联系方式,客户来源,星级,合作情况,客户类型,产品类型,累计合作金额,备注,id,报价 FROM kehu WHERE 采购账号 LIKE '%%%%%s%%%%'" % str(ui.lineEdit_21.text())
        else :
            sql = "SELECT 日期,公司名,采购账号,对接人,联系方式,客户来源,星级,合作情况,客户类型,产品类型,累计合作金额,备注,id,报价 FROM kehu WHERE ID = '{}' ".format(str(ui.lineEdit_24.text()))
        ds = pd.DataFrame(pd.read_sql(sql, conn))
        ds.rename(columns={'星级': '客户等级','合作情况':'开发层级'},inplace=True)
        if ds.empty :
            pass
        else:
            model = QStandardItemModel()
            ...
            ui.lineEdit_20.setText(str(ds.at[0, '对接人']))
            ui.lineEdit_19.setText(str(ds.at[0, '公司名']))
            ui.lineEdit_21.setText(str(ds.at[0, '采购账号']))
            ui.lineEdit_22.setText(str(ds.at[0, '联系方式']))
            ui.lineEdit_17.setText(str(ds.at[0, '报价']))
            ui.lineEdit_18.setText(str(ds.at[0, '备注']))
            ui.lineEdit_23.setText(str(ds.at[0, '累计合作金额']))
            ui.lineEdit_24.setText(str(ds.at[0, 'id']))
            ui.lineEdit_26.setText(str(ds.at[0, '客户来源']))
            ui.lineEdit_27.setText(str(ds.at[0, '日期']))
            ui.comboBox.addItem(str(ds.at[0, '开发层级']), 0)
            ui.comboBox_2.addItem(str(ds.at[0, '客户等级']),0)
            ui.comboBox_4.addItem(str(ds.at[0, '客户类型']), 0)
            ui.comboBox_5.addItem(str(ds.at[0, '产品类型']),0)
            ds1 = pd.DataFrame(pd.read_excel('D:\配置\配置.xlsx', sheet_name='下拉框'))
            for i in ds1['客户等级']:
                if pd.isnull(i):
                    pass
                else:
                    if str(ds.iat[0, 6]).strip() is not i.strip() :
                        ui.comboBox_2.addItem(i)
            for i in ds1['开发层级']:
                if pd.isnull(i):
                    pass
                else:
                    if str(ds.iat[0, 8]).strip() is not i.strip() :
                        ui.comboBox.addItem(i)
            for i in ds1['客户类型']:
                if pd.isnull(i):
                    pass
                else:
                    if str(ds.at[0, '客户类型']).strip() is not i.strip() :
                        ui.comboBox_4.addItem(i)
            for i in ds1['产品类型']:
                if pd.isnull(i):
                    pass
                else:
                    if str(ds.at[0, '产品类型']).strip() is not i.strip() :
                        ui.comboBox_5.addItem(i)
    if a1+a2+a3+a4 == 4 or a1+a2+a3+a4 == 0  :
        if ui.radioButton_4.isChecked() == True:
            sql = "SELECT 日期,公司名,采购账号,对接人,联系方式,客户来源,星级,合作情况,客户类型,产品类型,累计合作金额,备注,id,报价 FROM kehu WHERE 合作情况 LIKE '%%%%%s%%%%'" % str(ui.comboBox.currentText())
        else:
            sql = "select 日期,公司名,采购账号,对接人,联系方式,客户来源,星级,合作情况,客户类型,产品类型,累计合作金额,备注,id,报价 from kehu order by id  desc "
        ds = pd.DataFrame(pd.read_sql(sql, conn))
        ds.rename(columns={'星级': '客户等级', '合作情况': '开发层级'}, inplace=True)
        if ds.empty :
...
def show_gou(self):
    ...
    if a1+a2+a3+a4+a5 == 1 :
        if ui.lineEdit_20.text() != "":
            ...
            sql = "SELECT * FROM goutong WHERE 联系账号 LIKE '%%%%%s%%%%' order by id desc" % str(ui.lineEdit_21.text())
        elif ui.lineEdit_25.text() != "":
            sql = "SELECT * FROM goutong WHERE 产品 LIKE '%%%%%s%%%%' order by id desc" % str(ui.lineEdit_25.text())
        else :
            sql = "SELECT * FROM goutong WHERE ID = '{}' order by id desc" .format(str(ui.lineEdit_24.text()))
        ds = pd.DataFrame(pd.read_sql(sql, conn))
        if ds.empty :
            pass
        else:
...
def update_kehu(self):
    ...
    conn = pymssql.connect(server=host1, user=user1, password=passwd1, database=db1)
    cur = conn.cursor()
    sql = "update kehu set 日期='{}',公司名='{}',采购账号='{}',对接人='{}',联系方式='{}',报价='{}',星级='{}',合作情况='{}',累计合作金额='{}',备注='{}',客户来源='{}',客户类型='{}',产品类型='{}' where id ='{}'"
    sql2 = sql.format(ui.lineEdit_27.text(),ui.lineEdit_19.text(),ui.lineEdit_21.text(),ui.lineEdit_20.text(),ui.lineEdit_22.text(),ui.lineEdit_17.text(),ui.comboBox_2.currentText(),ui.comboBox.currentText(),ui.lineEdit_23.text(),ui.lineEdit_18.text(),ui.lineEdit_26.text(),ui.comboBox_4.currentText(),ui.comboBox_5.currentText(),ui.lineEdit_24.text())
    cur.execute(sql2)
    conn.commit()
    cur.close()
    conn.close()
...
def clean_kehu(self):
    ...
    ds = pd.DataFrame(pd.read_excel('D:\配置\配置.xlsx', sheet_name='下拉框'))
    cb = ui.comboBox
    cb2 = ui.comboBox_2
    cb3 = ui.comboBox_3
    cb4 = ui.comboBox_4
...
def insert_kehu(self):
    ...
    conn = pymssql.connect(server=host1, user=user1, password=passwd1, database=db1)
    cur = conn.cursor()
    sql = "INSERT INTO kehu(日期,公司名,采购账号,对接人,联系方式,报价,星级,合作情况,备注,客户来源,客户类型,产品类型) VALUES ('%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s','%s')" \
    % (ui.lineEdit_27.text(),ui.lineEdit_19.text(),ui.lineEdit_21.text(),ui.lineEdit_20.text(),ui.lineEdit_22.text(),ui.lineEdit_17.text(),ui.comboBox_2.currentText(),ui.comboBox.currentText(),ui.lineEdit_18.text(),ui.lineEdit_26.text(),ui.comboBox_4.currentText(),ui.comboBox_5.currentText())
    cur.execute(sql)
    conn.commit()
    tkinter.messagebox.showinfo('提示', "插入数据成功")
...
def allinsert_kehu(self):
    ...
    cur = conn.cursor()
    for i in range(0,len(df)):
        sql = "INSERT INTO kehu(公司名,采购账号,对接人,联系方式,报价,星级,合作情况,累计合作金额,备注,客户类型,产品类型) VALUES ('%s','%s','%s','%s','%s','%s','%s',%s,'%s','%s','%s')" \
        % (df.at[i,'公司名'], df.at[i,'采购账号'], df.at[i,'对接人'], df.at[i,'联系方式'],df.at[i,'报价'], df.at[i,'星级'],df.at[i,'合作情况'], df.at[i,'累计合作金额'], df.at[i,'备注'],df.at[i,'客户类型'],df.at[i,'产品类型'])
        cur.execute(sql)
        conn.commit()
    tkinter.messagebox.showinfo('提示', "批量插入数据成功")
